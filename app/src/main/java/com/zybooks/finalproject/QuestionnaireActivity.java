...
public class QuestionnaireActivity extends AppCompatActivity implements OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Create the Spinner for the mood options on the questionnaire
        ...
        ArrayAdapter<CharSequence> moodAdapter = ArrayAdapter.createFromResource(this,
                R.array.moodArray, android.R.layout.simple_spinner_item);
        ...
        {
            //Pre-conditions: the submitButton is clicked
            //Post-conditions: the MoodTrackerActivity is the current activity
            public void onClick(View view) {
